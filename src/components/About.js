...
export default function About() {
    ...
    const [btntex, setBtntext] = useState("Enable Light Mode")
   const toggleStyle = ()=>
    {
    ...
    return (
        ...
        <div className="accordion-item" style={myStyle}>
            ...
            <div className="accordion-body" style={myStyle}>
                <strong>This is the third item's accordion body.</strong> It is hidden by default,
                 until the collapse plugin adds the appropriate classNamees 
                 that we use to style each element. These classNamees control
        ...
        <button onClick={toggleStyle} type="button" className="btn btn-primary">{btntex}</button>
